                  ...
                  <div class="movie__data">
                    <div class="movie__data__duration">
                      ...
                      <div class="movie__data__schedule">
                          ...
                          <span>${daysOfWeek[movie.projected_at.getDay()]} ${movie.projected_at.getDate()} ${monthes[movie.projected_at.getMonth()]} - ${movie.projected_at.getHours()}h${String(movie.projected_at.getMinutes()).padStart(2, 0)}</span>
                    </div>
                      <div class="movie__data__schedule">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
